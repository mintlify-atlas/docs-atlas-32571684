...
<ParamField path="USER" type="string" required>
  The GitHub organization name. For all Node.js groups this is `nodejs`.
</ParamField>
...
<ParamField path="AGENDA_TAG" type="string" required>
  The GitHub label used to search for agenda items across the organization. Issues and pull requests carrying this label are automatically included in the meeting agenda.
</ParamField>
